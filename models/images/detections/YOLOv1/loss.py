from jaxmao.nn.losses import Loss
...
class YOLO_2bboxes(Loss):
    ...
    def calculate_loss(self, y_pred, y_true):
        iou1 = compute_iou(y_true[..., 1:5], y_pred[..., 1:5])
        iou2 = compute_iou(y_true[..., 1:5], y_pred[..., 6:10])
        responsible_mask = (jnp.argmax(jnp.stack([iou1, iou2], axis=0), axis=0)[..., None, None])
        # print('responsible_mask', responsible_mask.shape)
        
        obj_exists = y_true[..., :1]
        true_bbox_sqrt = jnp.concatenate([y_true[..., 1:3], (y_true[..., 3:5])], axis=-1)
        true_cls = y_true[..., 5:]
        ...
        selecteed_pred_bbox_sqrt = jnp.concatenate([selecteed_pred_bbox[..., :2], ((selecteed_pred_bbox[..., 2:]))], axis=-1)
        pred_cls = y_pred[..., 10:]
